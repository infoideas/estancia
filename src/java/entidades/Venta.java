...
public class Venta  implements java.io.Serializable {
     ...
     private Set<VentaRemito> ventaRemitos = new HashSet<VentaRemito>(0);

    public Venta() {
    }

	
    public Venta(Date fecCarga, Date fecMov, int idUsuario, BigDecimal subtotalSinIva, BigDecimal valorIva, BigDecimal valorTotal) {
    ...
    public Venta(Cliente cliente, LocalCarniceria localCarniceria, Date fecCarga, Date fecMov, int idUsuario, String tipoCompro, String puntoVenta, String numFact, String tipoFact, BigDecimal subtotalSinIva, BigDecimal porcIva, BigDecimal valorIva, BigDecimal valorTotal, String observaciones, Set<VentaDet> ventaDets, Set<VentaRemito> ventaRemitos) {
       ...
       this.ventaRemitos = ventaRemitos;
    }
    ...
    public Set<VentaRemito> getVentaRemitos() {
        return this.ventaRemitos;
    }
    
    public void setVentaRemitos(Set<VentaRemito> ventaRemitos) {
        this.ventaRemitos = ventaRemitos;
    }
